            ...
            <Row>
              ...
              <Form.Group controlId="CustomerId">
                ...
                <Form.Group >
                  ...
                  <Form.Control type="text" placeholder="Enter Relative's Name" />
                </Form.Group>
                <Form.Group>
                  <Form.Label>Relative's Relation</Form.Label>
                  <Form.Control type="text" placeholder="Enter Relative's Relation" />
                </Form.Group>
                ...
                <Form.Group>
                  ...
                  <Form.Control type="text" placeholder="Enter intro Member Code" />
                </Form.Group>
                <Form.Group>
                  <Form.Label>M Name</Form.Label>
                  <Form.Control type="text" placeholder="Enter intro Member Name" />
                </Form.Group>
                <Form.Group>
